...
public class VideoTest : MonoBehaviour
{
    ...
    static int mPreviewWidth = 960;
    static int mPreviewHeight = 720;
    bool state = false;
    ...
    void Start()
    {
        ...
        StartCoroutine(Test());
        haarCascade = new CascadeClassifier(Application.streamingAssetsPath + "/haarcascades/haarcascade_frontalface_default.xml");
    }
    ...
    void OnGUI()
    {
        if (isPlay)
        {
            ...
            rt.LoadImage(bs);
            rt.Apply();
            GUI.DrawTexture(new UnityEngine.Rect((Screen.width - mPreviewWidth) * 0.5f, (Screen.height - mPreviewHeight) * 0.5f, mPreviewWidth, mPreviewHeight), rt, ScaleMode.StretchToFill);
        }
